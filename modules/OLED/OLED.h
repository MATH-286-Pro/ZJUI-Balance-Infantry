...
extern void OLED_showBMP(uint8_t x0,uint8_t y0,uint8_t x1,uint8_t y1, uint8_t BMP[]);

extern void OLED_showBMP_gram(uint8_t BMP[128][8]);

extern void OLED_mask_write_gram(uint8_t xstart, uint8_t ystart,uint8_t BMP[128][8]);

extern void OLED_mask_clear_gram(uint8_t xstart, uint8_t ystart,uint8_t BMP[128][8]);
